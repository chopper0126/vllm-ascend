...
## replace run_dp_template.sh
32A_16F_FFN_Node.sh
32A_16F_ATTN_Node1.sh
32A_16F_ATTN_Node2.sh

```
# on 131
bash 32A_16F_FFN_Node.sh ffn 141.61.73.131
# on 132
python launch_online_dp.py --dp-size 32 --tp-size 1 --dp-size-local 16 --dp-rank-start 0 --dp-address 141.61.73.132 --dp-rpc-port 12321 --vllm-start-port 7100
# on 133
python launch_online_dp.py --dp-size 32 --tp-size 1 --dp-size-local 16 --dp-rank-start 16 --dp-address 141.61.73.132 --dp-rpc-port 12321 --vllm-start-port 7100
