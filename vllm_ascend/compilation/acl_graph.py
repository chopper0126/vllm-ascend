...
def update_mla_attn_params(update_stream, forward_context, runtime_shape,is_ubatch):
    ...
    for key, param, handle, event in zip(
            ...
            seq_lens_list = key.decode.seq_lens_list if is_ubatch else forward_context.attn_metadata[key].decode.seq_lens_list
