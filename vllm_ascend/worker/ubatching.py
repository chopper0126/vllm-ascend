...
class UBatchContext:
    ...
    def __enter__(self):
        ...
        print(f"context_id: {self.id}, enter ubatch_context", flush=True)
        return self
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        print(f"context_id: {self.id}, ubatch_context start set cpu_signal_event", flush=True)
        self.cpu_signal_event.set()
        self.cpu_wait_event.clear()
        print(f"context_id: {self.id}, ubatch_context finish set cpu_signal_event", flush=True)
        return False
